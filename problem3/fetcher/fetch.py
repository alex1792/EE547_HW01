...
def main():
    ...
    print("Created all shared directories", flush=True)
    ...
    print(f"Found {len(urls)} URLs to process", flush=True)
    ...
    for i, url in enumerate(urls, 1):
        ...
        try:
            ...
            print(f"  -> Success: {len(content)} bytes", flush=True)
    ...
    print(f"Successfully fetched {status['successful']} out of {status['urls_processed']} URLs", flush=True)
